...
|-------|-------------|----------|----------------------|
| **A** | **Safe / Cosmetic** | Docs, comments, typos, formatting | ✅ Auto-Apply |
| **B** | **Logic Change** | Refactors, new functions, tests | ⚠️ Require Approval |
| **C** | **High Impact** | Public API, dependencies, security, config | 🛑 Require Impact Analysis + Approval |
